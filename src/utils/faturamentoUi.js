...
export const LABELS_PENDENCIAS_FATURAMENTO = Object.freeze({
  ...
  competencia_fiscal_ausente: "Competência fiscal do serviço ainda não confirmada.",
  codigo_tributacao_nacional_ausente: "Código de Tributação Nacional ainda não informado.",
  determinacao_tributaria_servico_pendente: "Determinação tributária do serviço ainda não realizada.",
