...
const TEXTOS_PRODUTOS_POR_SEGMENTO = {
  ...
  oficina: {
    ...
    subtitulo:
      "Cadastre produtos e peças, acompanhe custos, margem e preco de venda para a oficina.",
    tituloFormularioNovo: "Novo Produto / Peça",
    tituloFormularioEdicao: "Editar Produto / Peça",
    tituloResultado: "Resultado do Produto / Peça",
    tituloLista: "Produtos / Peças Cadastrados",
    resumoItens: "Itens e peças cadastrados",
    ajudaRevenda: "Use este cadastro para peças e produtos comprados prontos.",
    ajudaSimples: "Use este tipo para kits ou pacotes vendidos como unidade final.",
    ajudaUnidade: "Use este tipo para peças e produtos vendidos por unidade.",
    botaoSalvar: "Salvar Produto / Peça",
    botaoAtualizar: "Atualizar Produto / Peça",
  },
  clientes: {
    titulo: "Produtos",
